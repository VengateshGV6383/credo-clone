...
const UserDetails = (props) => {
  ...
  return (
    <div className="row justify-content-evenly align-items-start">
      <div
        className="row row-cols-4 user-detail-card flex align-items-center justify-content-between"
        style={{
      ...
      >
        ...
        <div
          className="col-12 card m-1 user-detail-card"
          style={{
          ...
          <div className="card-body mt-1">
            ...
            <div className="card-text">
              ...
              <div className="row row-cols-2">
                ...
                <div className="col col-sm-5 font-weight-bold value">
                  Trichy
                </div>
              </div>
            </div>
        ...
        >
          <div className="card-body">
            ...
            <div className="row row-cols-2">
              ...
              <div className="col col-sm-8 font-weight-bold value">
                {weight}
              </div>
            </div>
            <div className="row row-cols-2">
